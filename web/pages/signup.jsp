...
<ul>
    ...
    <li>
        <canyon:label styleClass="desc" key="user.website"/>
    ...
    <li>
        ...
        <div class="group">
            ...
            <div>
                ...
                <p><canyon:label key="user.address.province"/></p>
            </div>
            <div class="left">
                ...
                <p><canyon:label key="user.address.postalCode"/></p>
            </div>
            <div>
                <canyon:country name="address.country" prompt="" default="${user.address.country}"/>
                <p><canyon:label key="user.address.country"/></p>
            </div>
        </div>
    </li>
